...
def draw_view3d(
    ...
    if flash > 0.0:
        ...
        if origin is not None:
            ...
            surf.blit(layer, (origin[0] - radius - 2, origin[1] - radius - 2), special_flags=pygame.BLEND_ADD)
...
def _barrel(surf: pygame.Surface, rect: pygame.Rect, orbit: Orbit) -> None:
    ...
    layers.append((ECAL[0], ECAL_HALF, (36, 78, 150)))
    layers.append((ECAL[1], ECAL_HALF, (28, 64, 130)))
    layers.append((HCAL[0], HCAL_HALF, (78, 52, 36)))
    layers.append((HCAL[1], HCAL_HALF, (62, 42, 30)))
...
def _dot(surf, projected, color) -> None:
    ...
    surf.blit(glow, (center[0] - 14, center[1] - 14), special_flags=pygame.BLEND_ADD)
